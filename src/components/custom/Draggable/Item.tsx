...
function Item({ children }: ItemProps) {
   ...
   const [{ index, onDragStart, uniqueId, isActive }, { hoveringId, activeId, hoveringIndx, activeIndx, activeDy }] = [
      context.item,
      context.state,
   ]
   ...
   console.log(uniqueId, wasSelected)
   ...
   return (
      <>
         ...
         <div
            ...
            onMouseDown={(e) => {
               {
                  setWasSelected(true), onDragStart(e, uniqueId)
               }
            }}
            ref={(node) => {
         ...
         <div
            ...
            style={{
               ...
               opacity: uniqueId / 10,
               background: wasSelected ? "red" : "blue",
            }}
            className={`bg-red2`}
         />
      </>
